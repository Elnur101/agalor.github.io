        ...
        <div class="row">
            <div class="col-6 col-sm-6 col-md-4 col-lg-4 col-xl-3">
                ...
                <div class="wb-social-media">
                    <a href="#" class="bh"><i class="fa fa-instagram"></i></a>
                    <a href="#" class="fb"><i class="fa fa-facebook-official"></i></a>
                    <a href="#" class="vn"><i class="fa fa-vk"></i></a>
            ...
            <div class="col-6 col-sm-6 col-md-4  col-lg-3 col-xl-3">
                <div class="language-and-currency-btn">
                    ...
                    <img src="/web/public/img/flag-icon.jpg" alt="flag-icon">
                    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                        <div class="btn-group" role="group">
                            ...
                            <div class="dropdown-menu wd-btn-country-list" aria-labelledby="btnGroupDrop3">
                                <a class="dropdown-item" href="#"><img src="/web/public/img/flag-icon-2.png" alt="flag-icon"> Bangla</a>
                                <a class="dropdown-item" href="#"><img src="/web/public/img/flag-icon-3.png" alt="flag-icon"> Spanish</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            ...
            <div class="order-2 order-sm-1 col-2 col-sm-2 col-md-4 d-block d-lg-none">
                <div class="accordion-wrapper hide-sm-up">
                    ...
                    <ul id="mobilemenu" class="accordion">
                        <!-- <li class="mob-logo"><a href="index.html"><img src="/web/public/img/logo.png" alt=""></a></li>-->
            ...
            <div class="order-1 order-sm-2  col-12 col-sm-4 col-md-4 col-lg-2 col-xl-2">
                <div class="blrub-logo">
                    <a href="index.html">
                        <img src="/web/public/img/logo.png" alt="Logo">
                    </a>
                </div>
            </div>
                ...
                <div class="acc-header-wraper">
                    <div class="account-section">
                        <button class="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg2">
                            <i class="fa fa-user" aria-hidden="true"></i><span>Login/Register</span>
                        </button>
                                                        ...
                                                        <div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="login-tab">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 p0 brand-description-area">
                                                                    <img src="/web/public/img/login-img-1.jpg" class="img-fluid" alt="">
                                                        ...
                                                        <div class="tab-pane fade" id="sign-up" role="tabpanel" aria-labelledby="sign-up-tab">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 p0 brand-login-section">
                                                                    <img src="/web/public/img/login-img-2.jpg" class="img-fluid" alt="">
                                                                    <div class="brand-description">
                                                                        <div class="brand-logo">
                                                                            <img src="/web/public/img/logo.png" alt="Logo">
                                                                        </div>
                        ...
                        <div class="dropdown wd-compare-btn">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu2">
                                <div class="wd-item-list">
                                    <div class="media">
                                        <img class="d-flex mr-3" src="/web/public/img/cart-img-1.jpg" alt="cart-img">
                                        <div class="media-body">
                                    ...
                                    <div class="media">
                                        <img class="d-flex mr-3" src="/web/public/img/cart-img-2.jpg" alt="cart-img">
                                        <div class="media-body">
                                            <h6 class="mt-0 list-group-title">Voyage Yoga Bag</h6>
                                            <div class="rating">
                                                <a href="#"><i class="fa fa-star active-color" aria-hidden="true"></i></a>
                        ...
                        <ul class="wd-megamenu-ul">
                            ...
                            <li class="pos-inherit"><a href="shop-left-sidebar.html" class="main-menu-list ">Shortcode <i class="fa fa-angle-down angle-down" aria-hidden="true"></i></a>
                                <ul class="single-dropdown megamenu">
                                    ...
                                    <li>
                                        <a href="product-details-scroll.html" class="add-img"><img src="/web/public/img/nav-img-1.jpg" class="figure-img img-fluid" alt="Product Img"></a>
                                        <a href="product-details-scroll.html" class="add-img"><img src="/web/public/img/nav-img-2.jpg" class="figure-img img-fluid" alt="Product Img"></a>
                                    </li>
                                </ul>
                            </li>
            ...
            <div class="container">
                <div class="row no-gutters">
                    <div class="slider-text fadeInUp animated order-2 order-sm-1  col-sm-6 col-md-7">
                        <h1 class="slider-title">Добро пожаловать<span class="strong">– Lets Compare</span></h1>
            ...
            <div class="container">
                <div class="row no-gutters">
                    ...
                    <div class="col-sm-6 col-md-5 order-1 order-sm-2 slider-img-two fadeInDown animated">
                        <img src="/web/public/img/slider-img/slider2.png" alt="">
                    </div>
                </div>
            </div>
        </div>
